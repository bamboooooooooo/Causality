...
public class IdenticalConnection extends JFrame{
	...
	public IdenticalConnection(DrawJpanel djp,JPanel jp,Identical identical,List<Status> staList) {
		this.drawJpanel = djp;
		this.jpanel = jp;
		this.identical = identical;
		this.statusList = new ArrayList<Status>(staList);
		this.start = new Status();
		this.end = new Status();
		if(identical != null) {
			this.start = identical.getStart();
			this.end = identical.getEnd();
		}
		this.inputSta = start.getName();
		this.outputSta = end.getName();
		// TODO Auto-generated constructor stub
		createIdenticalConnection();
	}

	private void createIdenticalConnection() {
		...
		deleteButton.addActionListener(new ActionListener(){
			...
			// TODO Auto-generated method stub
				if(identical != null)
					ch.deleteIdentical(drawJpanel.getIdenticalList(), drawJpanel.getPointList(), drawJpanel.getIdenticalList().indexOf(identical));
				jpanel.repaint();
				dispose();
			}
		});	
